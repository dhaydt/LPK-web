...
<script>
import Liputan from "../../components/about/liputan";
import Legalitas from "../../components/about/legalitas";
import Cabang from "../../components/about/cabang.vue";
import Struktur from "../../components/about/struktur";
