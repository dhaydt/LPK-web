    ...
    <b-card>
      ...
      <b-modal ref="users" id="users" hide-footer title="Edit Data">
        <div class="d-block text-left">
          <b-form-group id="input-group-1" label="Visi" label-for="input-1">
            <b-form-input
              id="input-1"
              v-model="editData.visi"
              type="text"
              required
            ></b-form-input>
          </b-form-group>

          <b-form-group id="input-group-11" label="Misi" label-for="input-11">
            <b-form-input
              id="input-11"
              v-model="editData.misi"
              type="text"
              required
            ></b-form-input>
          </b-form-group>
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "visi", sortable: true, label: "Visi" },
        { key: "misi", sortable: true, label: "Misi" },
        { key: "action" },
      ],
      visiUrl: "",
      loading: "",
