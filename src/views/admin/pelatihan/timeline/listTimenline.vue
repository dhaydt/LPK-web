...
export default {
  data() {
    return {
      ...
      fields: [
        ...
        { key: "img", label: "Foto" },
        { key: "date_range", sortable: true, label: "Waktu" },
        { key: "action" },
      ],
      visiUrl: "",
      imgUrl: "",
  ...
  created() {
    ...
    this.visiUrl = mainUrl + "/timeline";
    this.groupUrl = mainUrl + "/timelineGroup";
    this.imgUrl = mainUrl + "/images/timeline/";
    this.getLegal();
    this.getGroup();
  },
  ...
  methods: {
    ...
    async SaveUsers() {
      ...
      formData.append("lokasi", this.editData.lokasi);
      formData.append("url", this.editData.url);
      formData.append("bulan", this.editData.bulan);
      formData.append("date_range", this.editData.date_range);
