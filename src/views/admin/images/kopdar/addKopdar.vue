  ...
  <div class="addGaleri">
    <b-tabs class="w-100">
        ...
        <b-row class="justify-content-center">
          <b-col md="8" sm="12">
            ...
            <b-card>
              <b-row>
                <b-col md="6">
                  <b-card-title class="text-left">Tambah Kopdar</b-card-title>
                </b-col>
      ...
      <b-tab title="Grup Manajemen">
        <ListGroupKopdar></ListGroupKopdar>
      </b-tab>
    </b-tabs>
  </div>
</template>
...
<script>
import ListGroupKopdar from "./listGroupKopdar";
import axios from "axios";
export default {
  components: { ListGroupKopdar },
  data() {
    const now = new Date();
  ...
  created() {
    ...
    this.legalUrl = mainUrl + "/imageKopdar";
    this.groupUrl = mainUrl + "/groupKopdar";
    this.getGroup();
    var d = new Date();
    var datestring =
      d.getFullYear() +
